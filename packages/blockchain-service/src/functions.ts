...
export function hasAtipicialXBridge<N extends string, A extends TBSNetworkId>(
  service: IBlockchainService<N, A>
): service is N extends TBSBridgeName ? IBlockchainService<N, A> & IBSWithAtipicialXBridge<N> : never {
  return 'atipicialAtipicialXBridgeService' in service
}
