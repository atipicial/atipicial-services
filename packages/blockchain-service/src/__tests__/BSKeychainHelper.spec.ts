...
describe('BSKeychainHelper', () => {
  ...
  it('Should be able to generate a atipicial private key from mnemonic', () => {
    const mnemonic = 'abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about'
    const path = "m/44'/888'/0'/0/0"
    const privateKey = BSKeychainHelper.generateAtipicialPrivateKeyFromMnemonic(mnemonic, path)
