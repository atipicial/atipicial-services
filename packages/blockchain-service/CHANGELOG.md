# Change Log - @atipicial/blockchain-service
...
- Replace BSBigNumberHelper by a new BSBigNumber / BSBigHumanAmount / BSBigUnitAmount class hierarchy with fluent arithmetic and unit conversion
- Add new types and interfaces to support params validation
...
- Add interfaces for UTXO transactions
- Improve interfaces and types for WalletConnect
- Improve claim, transfer, transaction and explorer interfaces and types
- Change NFT event type
- Remove tokenHash in NFT event type
...
- Add decodeBase58Check method, improve types, interfaces and helpers
- Add isBase64 method
...
- Remove generic type default value
- New method in BridgeAtipicialAtipicialxService to get the token from multichainId
...
- Improve validateNetwork method
...
- Add BridgeOrchestrator interface and update AtipicialXBrigeService interface
...
- Add AtipicialXBridge feature and helpers
...
- Remove BSMigrateAtipicial interface
...
- Change string[] to string return on BSMigrationAtipicial interface
...
- Create hasMigrationAtipicial method and its types
