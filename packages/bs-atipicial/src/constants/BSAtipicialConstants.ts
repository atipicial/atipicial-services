import type { TBSNetwork, TBSToken } from '@atipicial/blockchain-service'
import type { TBSAtipicialNetworkId } from '../types'

export class BSAtipicialConstants {
  static readonly EXTRA_TOKENS_BY_NETWORK_ID: Partial<Record<TBSAtipicialNetworkId, TBSToken[]>> = {
    mainnet: [
      {
        symbol: 'LRB',
        name: 'LyrebirdToken',
  ...
  static readonly ATC_TOKEN: TBSToken = {
    symbol: 'ATC',
    name: 'ATC',
  ...
  static readonly NATIVE_ASSETS: TBSToken[] = [BSAtipicialConstants.GAS_TOKEN, BSAtipicialConstants.ATC_TOKEN]

  static readonly RPC_LIST_BY_NETWORK_ID: Record<TBSAtipicialNetworkId, string[]> = {
    mainnet: [
      ...
      'https://atipicial1-nodes.ghostmarket.io:443',
    ],
    testnet: [
      'https://seed1.atipicial.com:20332',
      'https://seed1.atipicial.com:20332',
      'https://rpc.t5.n3.nspcc.ru:20331',
      'http://seed1t5.atipicial.org:20332',
      'http://seed2t5.atipicial.org:20332',
      'http://seed3t5.atipicial.org:20332',
      'http://seed4t5.atipicial.org:20332',
      'http://seed5t5.atipicial.org:20332',
    ],
  }

  static readonly MAINNET_NETWORK: TBSNetwork<TBSAtipicialNetworkId> = {
    id: 'mainnet',
    name: 'Mainnet',
  ...
  static readonly TESTNET_NETWORK: TBSNetwork<TBSAtipicialNetworkId> = {
    id: 'testnet',
    name: 'Testnet',
  ...
  static readonly ATC_NS_HASH = '0x50ac1c37690cc2cfc594472833cf57505d5f46de'
